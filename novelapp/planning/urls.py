...
urlpatterns = [
    ...
    path('novel/<int:novel_pk>/characters/reorder/', views.character_reorder_view, name='character_reorder'),
    ...
    path('novel/<int:novel_pk>/locations/reorder/', views.location_reorder_view, name='location_reorder'),
    ...
    path('novel/<int:novel_pk>/items/reorder/', views.item_reorder_view, name='item_reorder'),
